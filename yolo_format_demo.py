...
def main():
    ...
    print("\n🌐 TensorBoard Access:")
    print("   Command: tensorboard --logdir runs/train-seg/yolo_food_segmentation")
    ...
    file_structure = {
        ...
        "Training Scripts": ["organize_yolo_dataset.py", "train_yolo_format.py", "segment/train.py"],
        "Inference Scripts": ["yolo_inference.py", "instance_segmentation_inference.py"],
        "Visualization": ["create_tensorboard_demo.py", "create_inference_thumbnails.py"],
    }
    ...
    usage_examples = [
        (
            "Train model",
            "python segment/train.py --data yolo_dataset/data.yaml --cfg models/segment/yolov5s-seg.yaml --weights yolov5s-seg.pt",
        ),
    ...
    print("\n🎯 Summary:")
    print("   ✓ Dataset organized in proper YOLO format")
    print("   ✓ Training pipeline configured")
    print("   ✓ TensorBoard metrics available")
    print("   ✓ Inference scripts ready")
    print("   ✓ Visualization tools prepared")
    print("   ✓ Thai food segmentation (9 classes)")
