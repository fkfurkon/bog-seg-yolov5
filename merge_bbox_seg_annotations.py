...
def main():
    ...
    parser.add_argument(
        "--bbox-root", default="dataset/annotation/boundingbox", help="Path to bounding box annotation directory"
    )
    parser.add_argument(
        "--seg-root", default="dataset/annotation/segmentation", help="Path to segmentation annotation directory"
    )
    parser.add_argument("--output-root", default="merged_dataset", help="Path to output merged dataset directory")
    parser.add_argument(
        "--format", choices=["bbox", "polygon", "both"], default="both", help="Output annotation format"
    )
    parser.add_argument("--preview", action="store_true", help="Preview merge without creating output")
