...
def train_yolo_model(
    ...
    hyp_file = "hyp_food_classification.yaml"
...
def main():
    ...
    parser.add_argument("--data", default="yolo_dataset_final/data.yaml", help="Path to dataset YAML file")
    parser.add_argument(
        "--model",
        choices=["n", "s", "m", "l", "x"],
        default="s",
    ...
    parser.add_argument("--name", default="final_merged_food_model", help="Experiment name")
