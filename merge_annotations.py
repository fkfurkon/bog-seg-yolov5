...
def create_merged_dataset():
    ...
    print(f"   ├── labels/")
    print(f"   │   ├── train/ (merged annotations)")
    print(f"   │   └── val/ (merged annotations)")
    print(f"   ├── data.yaml")
    print(f"   ├── train.txt")
    print(f"   └── val.txt")
...
if __name__ == '__main__':
    ...
    print(f"   python segment/train.py --data {merged_dir}/data.yaml --cfg models/segment/yolov5s-seg.yaml --weights yolov5s-seg.pt")
